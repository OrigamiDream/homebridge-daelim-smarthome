...
export enum InfoSubTypes {
    NOTICE_LIST_REQUEST = 1,
    NOTICE_LIST_RESPONSE = 2,
    NOTICE_CHECK_REQUEST = 3,
    NOTICE_CHECK_RESPONSE = 4,
    PARCEL_LIST_REQUEST = 5,
    PARCEL_LIST_RESPONSE = 6,
    PARCEL_CHECK_REQUEST = 7,
    PARCEL_CHECK_RESPONSE = 8,
    ...
    CCTV_OFF_REQUEST = 15,
    CCTV_ON_RESPONSE = 16,
    CCTV_CHANNEL_CHANGE_REQUEST = 17,
    LOCATION_TAG_INFO_REQUEST = 18,
    LOCATION_TAG_INFO_RESPONSE = 19,
    LOCATION_MAP_REQUEST = 20,
    LOCATION_MAP_RESPONSE = 21,
    LOCATION_EMERGENCY_LIST_REQUEST = 22,
    LOCATION_EMERGENCY_LIST_RESPONSE = 23,
    LOCATION_EMERGENCY_MAP_REQUEST = 24,
    LOCATION_EMERGENCY_MAP_RESPONSE = 25,
    LOCATION_MAP_IMAGE_REQUEST = 26,
    LOCATION_MAP_IMAGE_RESPONSE = 27,
    SHOP_LIST_REQUEST = 28,
    SHOP_LIST_RESPONSE = 29,
    NOTICE_NOTIFICATION = 30,
    PARCEL_NOTIFICATION = 31,
    VISITOR_NOTIFICATION = 32,
    EMERGENCY_CALL_NOTIFICATION = 33,
    NOTICE_IMAGE_REQUEST = 34,
    NOTICE_IMAGE_RESPONSE = 35,
    VISITOR_DELETE_REQUEST = 36,
    VISITOR_DELETE_RESPONSE = 37,
    CAR_GETTING_IN_LIST_REQUEST = 38,
    CAR_GETTING_IN_LIST_RESPONSE = 39,
    CAR_GETTING_IN_VISITOR_LIST_REQUEST = 40,
    CAR_GETTING_IN_VISITOR_LIST_RESPONSE = 41,
    CAR_GETTING_IN_VISITOR_REGISTRATION_REQUEST = 42,
    CAR_GETTING_IN_VISITOR_REGISTRATION_RESPONSE = 43,
    CAR_GETTING_IN_VISITOR_DELETE_REQUEST = 44,
    CAR_GETTING_IN_VISITOR_DELETE_RESPONSE = 45,
    CAR_GETTING_IN_INFO_NOTIFICATION = 46,
    ACCESS_LIST_REQUEST = 47,
    ACCESS_LIST_RESPONSE = 48,
    MAINTENANCE_FEE_PER_MONTH_REQUEST = 49,
    MAINTENANCE_FEE_PER_MONTH_RESPONSE = 50,
    MAINTENANCE_FEE_PER_YEAR_REQUEST = 51,
    MAINTENANCE_FEE_PER_YEAR_RESPONSE = 52,
    CAR_GETTING_IN_DELETE_REQUEST = 53,
    CAR_GETTING_IN_DELETE_RESPONSE = 54,
    ACCESS_DELETE_REQUEST = 55,
    ACCESS_DELETE_RESPONSE = 56,
    UNCHECKED_MESSAGE_REQUEST = 57,
    UNCHECKED_MESSAGE_RESPONSE = 58,
    USE_HISTORY_REQUEST = 59,
    USE_HISTORY_RESPONSE = 60,
    ACCESS_INFO_NOTIFICATION = 61,
    USE_HISTORY_NOTIFICATION = 62,
    LOCATION_TAG_INFO_NOTIFICATION = 63,
    PARKING_LOCATION_REQUEST = 64,
    PARKING_LOCATION_RESPONSE = 65,
    CAR_GETTING_IN_LOCATION_REQUEST = 66,
    CAR_GETTING_IN_LOCATION_RESPONSE = 67,
    CAR_GETTING_IN_LOCATION_PICTURE_REQUEST = 68,
    CAR_GETTING_IN_LOCATION_PICTURE_RESPONSE = 69,
    PARKING_STATUS_REQUEST = 70,
    PARKING_STATUS_RESPONSE = 71
}
